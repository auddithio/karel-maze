...
/* 
 * This function prints a memory report of the total memory used.
 * It consists of a count of the total number of allocations and 
 * frees and prints out the backtrace frames of any memory leaks.
 *
 * @params  none
 * @returns none
 */

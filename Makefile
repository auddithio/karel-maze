...
MY_MODULES = project-module.o gpio.o timer.o printf.o LSM6DS33.o board.o gl.o accel.o karel_world.o game.o
...
CFLAGS	= -I/Users/dipakkumar/cs107e_home/project/include -Og -g -std=c99 $$warn $$freestanding
